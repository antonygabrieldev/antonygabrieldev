<h1 align="center">👋 Olá, eu sou Antony Gabriel</h1>
...
Sou estudante de **Análise e Desenvolvimento de Sistemas (ADS)**, com foco em **Desenvolvimento Web e Front-end**.

Além da formação acadêmica, desenvolvo projetos próprios para colocar meus conhecimentos em prática, explorando desenvolvimento de interfaces, responsividade, experiência do usuário e publicação de aplicações web.

- 🎓 Estudante de **Análise e Desenvolvimento de Sistemas**
- 💻 Foco em **Desenvolvimento Web e Front-end**
- 🎨 Interesse em **UI/UX e interfaces modernas**
- 🚀 Desenvolvendo projetos reais para meu portfólio
